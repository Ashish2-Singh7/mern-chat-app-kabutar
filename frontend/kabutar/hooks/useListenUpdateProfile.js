...
const useListenUpdateProfile = (setRefetch) => {
    ...
    useEffect(() => {
        ...
        return () => socket?.off("profileUpdated"); // important as it's make's sure you are not listening to this event more than once.
...
export default useListenUpdateProfile;
